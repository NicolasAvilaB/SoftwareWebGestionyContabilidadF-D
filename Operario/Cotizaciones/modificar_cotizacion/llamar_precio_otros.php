...
$consulta2 = mysqli_query($conexion2,"Call Mostrar_Precio_Desc1_Proveedor ('$nombre_otros')");
$consulta3 = mysqli_query($conexion3,"Call Mostrar_Precio_Desc2_Proveedor ('$nombre_otros')");
$consulta4 = mysqli_query($conexion4,"Call Mostrar_Precio_Desc1_Venta ('$nombre_otros')");
$consulta5 = mysqli_query($conexion5,"Call Mostrar_Precio_Desc2_Venta ('$nombre_otros')");
$consulta6 = mysqli_query($conexion6,"Call Mostrar_Precio_Ganancia ('$nombre_otros')");
