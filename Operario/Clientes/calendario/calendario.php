...
<div class="tablascroll2">
        ...
        <div id="lateral-derecho">
            ...
            <p>&nbsp;</p>
            <div id="horario_nuevo">
                <label><strong>Horario:&nbsp;&nbsp;</strong>
                    <div id="horario_bd"></div>
        ...
        <aside id="cuadrado_modal2" class="cuadrado_modal2">
            ...
            <div id="rep_rest" style="padding:25px;" style="display:none;">
                ...
                <div id="scroll">
                    ...
                    &nbsp;&nbsp;<!--<button class="boton_dejarpendiente" id='dejarpendiente_modal'>Dejar Pendiente</button>--><button class="boton_datosrestificacion" id='medidas_restificacion' style="display:none;">Revisar Rectificación</button>
                    <div id="informes"></div>
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>
...
var nuevoalias = jQuery.noConflict();
	 nuevoalias(document).ready(function(){
        function obtener_datos_fecha(texto, texto2){
            nuevoalias.ajax({
                url:"./calendario/horarios_x4.php",
                method:"POST",
        ...
        var controladorTiempo100 = "";
        nuevoalias(document).on("keyup","#fecha_inicio",function(){
            clearTimeout(controladorTiempo100);
            controladorTiempo100 = setTimeout(obtener_datos_fecha(nuevoalias('input#fecha_inicio').val(), nuevoalias('#tecnico').val()), 220);
				});
        var controladorTiempo100 = "";
        ...
        nuevoalias(document).on("click","#ver_datos",function(){
            ...
            if (tipo_dato == 'Instalación'){
                  ...
                  //obtener_datos_descripcion_instalacion_modal(FechaHora, '<?php echo $valor_nombre;?>');
                  llamar_modal2();
    ...
    function buscar_horario_bd(texto){
        /*nuevoalias.ajax({
            url:"./calendario/buscar_opciones_horario.php",
            method:"POST",
            data: {texto: texto},
            success: function(data){
                nuevoalias("#horario_nuevo").html(data);
            }
        });*/
    }
