...
$id2 = $_POST["id2"];
$b = $_POST["b"];
$consulta = mysqli_query($conexion,"Call Ingresar_Total_Cotizacion_Rollers ('$id_coti','$id_add','$nombre_add','$fecha_add','$subtotal0_add','$desc_add','$valor_ins','$otros','$id_empresa','$totales2_add','$valor_iva2_add','$total2_add','$valor_desc_add','$total_cancelar2_add','$subtotal8_otros','$id1','$id2','$b')");
if(!$consulta){
