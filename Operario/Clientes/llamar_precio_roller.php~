...
$conexion5 = mysqli_connect("127.0.0.1","cso72566_usersocifyd","usersocifyd","cso72566_socifyd");
$conexion6 = mysqli_connect("127.0.0.1","cso72566_usersocifyd","usersocifyd","cso72566_socifyd");
$conexion7 = mysqli_connect("127.0.0.1","cso72566_usersocifyd","usersocifyd","cso72566_socifyd");
$conexion8 = mysqli_connect("127.0.0.1","cso72566_usersocifyd","usersocifyd","cso72566_socifyd");
$conexion9 = mysqli_connect("127.0.0.1","cso72566_usersocifyd","usersocifyd","cso72566_socifyd");
$conexion10 = mysqli_connect("127.0.0.1","cso72566_usersocifyd","usersocifyd","cso72566_socifyd");
$conexion11 = mysqli_connect("127.0.0.1","cso72566_usersocifyd","usersocifyd","cso72566_socifyd");
$conexion12 = mysqli_connect("127.0.0.1","cso72566_usersocifyd","usersocifyd","cso72566_socifyd");
...
$ancho = $_POST["ancho"];
$alto = $_POST["alto"];
$nombre_roller = $_POST["nombre_roller"];
$valor_ajax = 0;
$valor_accion = 0;
$valor_desc1prov = 0;
$valor_desc2prov = 0;
...
$consulta = mysqli_query($conexion,"Call Mostrar_Precio_Roller ('$ancho','$alto','$nombre_roller')");
$consulta2 = mysqli_query($conexion2,"Call Mostrar_Precio_Desc1_Proveedor ('$nombre_roller')");
$consulta3 = mysqli_query($conexion3,"Call Mostrar_Precio_Desc2_Proveedor ('$nombre_roller')");
$consulta4 = mysqli_query($conexion4,"Call Mostrar_Precio_Desc1_Venta ('$nombre_roller')");
$consulta5 = mysqli_query($conexion5,"Call Mostrar_Precio_Desc2_Venta ('$nombre_roller')");
$consulta6 = mysqli_query($conexion6,"Call Mostrar_Precio_Ganancia ('$nombre_roller')");
...
if($row = mysqli_fetch_array($consulta)) {
    $cadena_de_texto = $nombre_roller;
    $cadena_buscada = 'Coleccion';
    $posicion_coincidencia = strrpos($cadena_de_texto, $cadena_buscada);
    if ($posicion_coincidencia === false) {
        $valor_ajax = $row[0];
    } else {
        $mult = 0;
        $mult = round($ancho * $alto / 1000000 * intval(result));
        $valor_ajax = intval(mult);
    }
