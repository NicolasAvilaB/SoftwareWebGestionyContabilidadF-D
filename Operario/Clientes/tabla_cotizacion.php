...
<table id='tabla_cotizar'>
    ...
    <tbody>
        <tr>
            ...
            <td id="cantidad_valor" contenteditable>1</td>
            <td id="ancho_valor" contenteditable>0</td>
            <td id="alto_valor" contenteditable>0</td>
