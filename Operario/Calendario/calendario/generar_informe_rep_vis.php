   ...
   function Header()
   {
       if ($this->PageNo() == 1){
        ...
        //Salto de línea
            ...
            $this->Cell(60,5,utf8_decode('RESTIFICACIÓN'));
            $this->Ln(8);
            $this->SetFont('Arial','',12);
            $this->Cell(-1);
            $this->Cell(60,5,'Fecha:  '.strftime("%A, %d de %B del %Y", strtotime($fecha_ingreso)).'.-');
