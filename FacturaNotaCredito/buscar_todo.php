...
if($consulta = $conexion->query("Call Buscar_Factura_Todo()")){
    ...
    if ($consulta) {
        while($row = mysqli_fetch_array($consulta)){
            ...
            echo "<tr>
                    ...
                    <td><input type='date' min='2005-01-01' max='2100-12-31' value='".$row[3]."'/></td>
                    <td contenteditable>".$row[4]."</td>
                    <td>".$row[6]."</td>
                    <td><button id='modificar' data-tipo='".$row[5]."'>Modificar</button></td>
