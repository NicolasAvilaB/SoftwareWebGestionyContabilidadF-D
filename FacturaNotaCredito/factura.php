    ...
    $(document).on("click","#eliminar",function(){
        ...
        if (tipo == 'Factura'){
            ...
            if (confirm("¿Desea eliminar este Crédito?")){
                ...
                obtener_datos_factura_credito("");
                alert("Se ha eliminado el Crédito");
            };
        }else if(dc == 'Factura'){
            if (confirm("¿Desea eliminar la Factura?")){
                $.ajax({
...
<label class= "titulo2">Factura y Nota Crédito </label>
...
<div class="tablascroll">
  <div id="pestanas">
      ...
      <button id="agrfacturatecnicos" class="botones_pestanas_inabilitados_f" onclick="openPage('agrfacturatecnico', this, 'white')" >Agregar Factura Técnico</button>
      <button id="retiroingresotecnicos" class="botones_pestanas_inabilitados_e" onclick="openPage('retiroingresotecnico', this, 'white')" >Ingreso Retiro Técnico</button>
  </div>
    <div id="ingfactura" class="tabcontent">
        ...
        <div id="seccion_notacredito">
            <label>Nota Venta Crédito:<input type="text" class="grid-item" id="notaventacredito_add" name="notaventacredito_add" placeholder="Nota Venta Crédito..." size="30" maxlength="70" autocomplete="off" /></label>
            <p></p>
            <label>Fecha Crédito:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="date" class="grid-item" id="fechacredito_add" name="fechacredito_add" min='2005-01-01' max='2100-12-31' placeholder="Fecha Crédito..." size="30" maxlength="70" autocomplete="off" /></label>
            <p></p>
            <label>N° Crédito:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" class="grid-item" id="ncredito_add" name="ncredito_add" placeholder="N° Crédito..." size="30" maxlength="70" autocomplete="off" /></label>
            <p></p>
            <label>Valor Crédito:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" class="grid-item" id="valorcredito_add" name="valorcredito_add" placeholder="Valor Crédito..." size="30" maxlength="70" autocomplete="off" /></label>
            <p></p>
            <button id="ingresar_credito" class="boton_ingresar_credito">Ingresar Crédito</button>
        </div>
        <br></br>
        <br></br>
        <br></br>
        ...
        <div style="float:right;">
            <select id="select_mes1" name="select_mes1">
                ...
                <option value='101'>Comparar solo Año</option>
    ...
    <div id="retiroingresotecnico" class="tabcontent">
        <div id="seccion_factura">
            ...
            <p></p>
            <label><strong>&nbsp;&nbsp;Técnico Retiro:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>
            <?php
                $conexion223 = mysqli_connect("127.0.0.1","nicolas_usersoc","usersocifyd","nicolas_socifyd") or die ("Error");
                mysqli_set_charset($conexion223,"utf8");
                $ejecutar223 = mysqli_query($conexion223,"select Instalador from Instaladores where Estado = 'Desactivar'");
            ...
            <p></p>
            <label><strong>&nbsp;&nbsp;Técnico Ingreso:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>
            <?php
                $conexion223 = mysqli_connect("127.0.0.1","nicolas_usersoc","usersocifyd","nicolas_socifyd") or die ("Error");
                mysqli_set_charset($conexion223,"utf8");
                $ejecutar223 = mysqli_query($conexion223,"select Instalador from Instaladores where Estado = 'Desactivar'");
