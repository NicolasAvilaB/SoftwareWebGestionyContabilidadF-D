...
if($consulta_porc_roller = $conexion->query("Call Mostrar_Porc_Roller")){
    echo "<button id='aplicar_porc4'>Guardar</button><label class='titulo_tabla_porcentaje'>Roller</label>
            <table id='accion5'> 
            <thead>
                <tr>
                    <th>Roller</th>
