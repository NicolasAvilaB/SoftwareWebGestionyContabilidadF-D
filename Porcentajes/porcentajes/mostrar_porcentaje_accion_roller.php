...
if($consulta_porc_roller = $conexion->query("Call Mostrar_Porc_Motor_Roller")){
    echo "<button id='aplicar_porc_accion_roller'>Guardar</button><label class='titulo_tabla_porcentaje'>Accionamiento Roller</label>
            <table id='accion5'> 
            <thead>
                <tr>
                    <th>Motor</th>
