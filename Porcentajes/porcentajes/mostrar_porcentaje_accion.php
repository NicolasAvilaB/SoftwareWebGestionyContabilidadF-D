...
if($consulta_porc_roller = $conexion->query("Call Mostrar_Porc_Motor")){
    echo "<button id='aplicar_porc_accion'>Guardar</button><label class='titulo_tabla_porcentaje'>Accionamiento Persiana</label>
            <table id='accion5'> 
            <thead>
                <tr>
                    <th>Motor</th>
