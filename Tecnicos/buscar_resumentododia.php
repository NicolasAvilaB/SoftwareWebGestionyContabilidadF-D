...
$texto2 = $_POST["texto2"];
$texto3 = "";
$consulta2 = mysqli_query($conexion2, "Call Consulta_Estado_Tecnico_WM ('$texto2')");
if($row2 = mysqli_fetch_array($consulta2)){
    $texto3 = $row2[0];
}
if($consulta = mysqli_query($conexion, "Call Consultar_FechaInstalacion_Inicio_Calendario_ResumenDia_Inst ('$texto','$texto2')") or die (mysqli_error($conexion))){
    echo "<div id='scroll2'><div id='customers'>
            <table id='tabla_resumendia' border='1px' style='width:99%;' align='center'>
            <thead id='encabezado_tabla_resumendia'>
                <tr>
                  <th>Horario</th>
                  <th>Tipo</th>
                  <th>N° Orden</th>
