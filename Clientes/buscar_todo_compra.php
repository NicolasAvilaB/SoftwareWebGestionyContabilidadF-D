        ...
        while($row = $consulta->fetch_assoc()){
            ...
            $consulta0 = $conexion0->query("Call Consultar_Cliente_Vendido('$id')");
                    if($row0 = $consulta0->fetch_assoc()){
                        ...
                        if($comparar_venta == 1){
                            echo "<tr><td>".$id."</td>
                            <td id='nombre_cliente' data-id_usuario='".$row["Id"]."' style='background-color:green; color:white;' contenteditable>".$row["Nombre"]."</td>
                            <td id='direccion_cliente' contenteditable>".$row["Direccion"]."</td>
