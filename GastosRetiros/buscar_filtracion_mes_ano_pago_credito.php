...
$texto = $_POST["texto"];
$texto2 = $_POST["texto2"];
if($consulta = mysqli_query($conexion, "Call Buscar_Pago_Credito_Filtracion_Mes_Ano ('$texto','$texto2')") or die (mysqli_error($conexion))){
    ...
    if ($consulta) {
        while($row = mysqli_fetch_array($consulta)){
            ...
            echo "<tr>
                    ...
                    <td><button id='eliminar_gasto' data-id_eliminar='".$row[0]."'>Eliminar</button></td>
            </tr>";
            $suma += intval($row[3]);
        }
    }
