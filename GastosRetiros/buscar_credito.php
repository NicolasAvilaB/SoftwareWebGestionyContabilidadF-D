...
$texto = $_POST["texto"];
if($consulta = mysqli_query($conexion, "Call Buscar_NCredito ('$texto')") or die (mysqli_error($conexion))){
    ...
    if ($consulta) {
        while($row = mysqli_fetch_array($consulta)){
            ...
            echo "<tr>
                    ...
                    <td><button id='eliminar_credito' data-id_eliminar='".$row[0]."'>Eliminar</button></td>
            </tr>";
            $suma += intval($row[3]);
        }
    }
