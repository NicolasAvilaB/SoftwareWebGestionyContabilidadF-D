...
$mes = $_POST["mes"]; 
$empr = $_POST["empr"];
if($consulta = $conexion->query("Call Prom_Venta1_Persianas_Mes_Empr('$mes','$empr')")){
...
$mes = $_POST["mes"];
$empr = $_POST["empr"];
if($consulta2 = $conexion2->query("Call Prom_Venta1_Rollers_Mes_Empr('$mes','$empr')")){
...
$mes = $_POST["mes"];
$empr = $_POST["empr"];
if($consulta3 = $conexion3->query("Call Prom_Venta1_Repuestos_Mes_Empr('$mes','$empr')")){
...
$mes = $_POST["mes"];
$empr = $_POST["empr"];
if($consulta4 = $conexion4->query("Call Prom_Venta1_Otross_Mes_Empr('$mes','$empr')")){
