...
$ano = $_POST["ano"]; 
$empr = $_POST["empr"];
if($consulta = $conexion->query("Call Prom_Venta1_Persianas_Empr_Ano('$ano','$empr')")){
        ...
        while($row = $consulta->fetch_assoc()){
            ...
            echo "
                <tr>
                    ...
                    <td><button id='ver_detalle_persianas_empr_ano' data-empr='".$empr."' data-ano='".$ano."' data-color='".$row["Id"]."'>Ver Detalle</button></td>
                </tr>
            ";
        }
    }
...
$ano = $_POST["ano"];
$empr = $_POST["empr"];
if($consulta2 = $conexion2->query("Call Prom_Venta1_Rollers_Empr_Ano('$ano','$empr')")){
    ...
    if ($consulta2) { 
        while($row2 = $consulta2->fetch_assoc()){
            ...
            echo "<tr>
                    ...
                    <td><button id='ver_detalle_rollers_empr_ano' data-empr='".$empr."' data-ano='".$ano."' data-color='".$row2["Id"]."'>Ver Detalle</button></td>
                </tr>";
        }
    }
    echo "</tbody></table></div>";
...
$ano = $_POST["ano"];
$empr = $_POST["empr"];
if($consulta3 = $conexion3->query("Call Prom_Venta1_Repuestos_Empr_Ano('$ano','$empr')")){
        ...
        while($row3 = $consulta3->fetch_assoc()){
            ...
            echo "
                <tr>
                    ...
                    <td><button id='ver_detalle_repuestos_empr_ano' data-empr='".$empr."' data-ano='".$ano."' data-color='".$row3["Id"]."'>Ver Detalle</button></td>
                </tr>
            ";
        }
    }
...
$ano = $_POST["ano"];
$empr = $_POST["empr"];
if($consulta4 = $conexion4->query("Call Prom_Venta1_Otross_Empr_Ano('$ano','$empr')")){
        ...
        while($row4 = $consulta4->fetch_assoc()){
            ...
            echo "
                <tr>
                    ...
                    <td><button id='ver_detalle_otros_empr_ano' data-empr='".$empr."' data-ano='".$ano."' data-color='".$row4["Id"]."'>Ver Detalle</button></td>
                </tr>
            ";
        }
    }
