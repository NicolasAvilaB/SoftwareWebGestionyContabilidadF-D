...
$ano = $_POST["ano"]; 
if($consulta = $conexion->query("Call Prom_Venta1_Persianas_Ano('$ano')")){
        ...
        while($row = $consulta->fetch_assoc()){
            ...
            echo "
                <tr>
                    ...
                    <td><button id='ver_detalle_persianas_ano' data-ano='".$ano."' data-color='".$row["Id"]."'>Ver Detalle</button></td>
                </tr>
            ";
        }
    }
...
$ano = $_POST["ano"];
if($consulta2 = $conexion2->query("Call Prom_Venta1_Rollers_Ano('$ano')")){
    ...
    if ($consulta2) { 
        while($row2 = $consulta2->fetch_assoc()){
            ...
            echo "<tr>
                    ...
                    <td><button id='ver_detalle_rollers_ano' data-ano='".$ano."' data-color='".$row2["Id"]."'>Ver Detalle</button></td>
                </tr>";
        }
    }
    echo "</tbody></table></div>";
...
$ano = $_POST["ano"];
if($consulta3 = $conexion3->query("Call Prom_Venta1_Repuestos_Ano('$ano')")){
        ...
        while($row3 = $consulta3->fetch_assoc()){
            ...
            echo "
                <tr>
                    ...
                    <td><button id='ver_detalle_repuestos_ano' data-ano='".$ano."' data-color='".$row3["Id"]."'>Ver Detalle</button></td>
                </tr>
            ";
        }
    }
...
$ano = $_POST["ano"];
if($consulta4 = $conexion4->query("Call Prom_Venta1_Otross_Ano('$ano')")){
        ...
        while($row4 = $consulta4->fetch_assoc()){
            ...
            echo "
                <tr>
                    ...
                    <td><button id='ver_detalle_otros_ano' data-ano='".$ano."' data-color='".$row4["Id"]."'>Ver Detalle</button></td>
                </tr>
            ";
        }
    }
