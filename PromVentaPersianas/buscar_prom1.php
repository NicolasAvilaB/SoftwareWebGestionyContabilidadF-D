...
if($consulta = $conexion->query("Call Prom_Venta1_Persianas_Todo()")){
        ...
        while($row = $consulta->fetch_assoc()){
            ...
            echo "
                <tr>
                    ...
                    <td><button id='ver_detalle_persianas' data-color='".$row["Id"]."'>Ver Detalle</button></td>
                </tr>
            ";
        }
    }
...
if($consulta2 = $conexion2->query("Call Prom_Venta1_Rollers_Todo()")){
        ...
        while($row2 = $consulta2->fetch_assoc()){
            ...
            echo "
                <tr>
                    ...
                    <td><button id='ver_detalle_rollers' data-color='".$row2["Id"]."'>Ver Detalle</button></td>
                </tr>
            ";
        }
    }
...
if($consulta3 = $conexion3->query("Call Prom_Venta1_Repuestos_Todo()")){
     echo " <div id='seccion_rollers'><p></p><label style='font-weight:bold;'>&nbsp;&nbsp;&nbsp;Repuestos</label>
        ...
        while($row3 = $consulta3->fetch_assoc()){
            ...
            echo "
                <tr>
                    ...
                    <td><button id='ver_detalle_repuestos' data-color='".$row3["Id"]."'>Ver Detalle</button></td>
                </tr>
            ";
        }
    }
...
if($consulta4 = $conexion4->query("Call Prom_Venta1_Otross_Todo()")){
     echo " <div id='seccion_rollers'><p></p><label style='font-weight:bold;'>&nbsp;&nbsp;&nbsp;Otros</label>
        ...
        while($row4 = $consulta4->fetch_assoc()){
            ...
            echo "
                <tr>
                    ...
                    <td><button id='ver_detalle_otros' data-color='".$row4["Id"]."'>Ver Detalle</button></td>
                </tr>
            ";
        }
    }
