...
$mes = $_POST["mes"]; 
if($consulta = $conexion->query("Call Prom_Venta1_Persianas_Mes('$mes')")){
...
$mes = $_POST["mes"]; 
if($consulta2 = $conexion2->query("Call Prom_Venta1_Rollers_Mes('$mes')")){
...
$mes = $_POST["mes"]; 
if($consulta3 = $conexion3->query("Call Prom_Venta1_Repuestos_Mes('$mes')")){
...
$mes = $_POST["mes"]; 
if($consulta4 = $conexion4->query("Call Prom_Venta1_Otross_Mes('$mes')")){
