...
//Cabecera de página
   ...
   {            //foreach($header as $col)
        ...
        $sumaca2 =0;
        $suma_subrep = 0;
        $consulta2 = mysqli_query($conexion2, "select FinalCrece, Cantidad, Ancho, Alto, IdMotor, IdColor, ValorUn, ValorTotal from Cotizaciones where IdTotalCotizacion = '$id'");
