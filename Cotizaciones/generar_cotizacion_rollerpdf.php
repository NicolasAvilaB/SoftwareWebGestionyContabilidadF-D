...
//Cabecera de página
   ...
   function TablaSimple()
   {
        ...
        $consulta2 = mysqli_query($conexion2, "select FinalCrece, Cantidad, Ancho, Alto, IdMotor, IdColor, ValorUn, ValorTotal from Cotizaciones where IdTotalCotizacion = '$id_roller'");
