...
$c = $_POST["c"];
$consulta = mysqli_query($conexion,"Call Ingresar_Total_Cotizacion_Otros ('$id_coti','$id_add','$nombre_add','$fecha_add','$subtotal0_add','$desc_add','$otros','$id_empresa','$totales2_add','$valor_iva2_add','$total2_add','$valor_desc_add','$total_cancelar2_add','$subtotal8_otros','$c')") or die (mysqli_error($conexion));
if(!$consulta){
