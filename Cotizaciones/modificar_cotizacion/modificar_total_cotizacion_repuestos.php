...
$id2 = $_POST["id2"];
$c = $_POST["c"];
$consulta = mysqli_query($conexion,"Call Modificar_Total_Cotizacion_Repuestos ('$id_coti','$id_add','$nombre_add','$fecha_add','$subtotal0_add','$desc_add','$otros','$id_empresa','$totales2_add','$valor_iva2_add','$total2_add','$valor_desc_add','$total_cancelar2_add','$subtotal8_otros','$id1','$id2','$c')");
if(!$consulta){
