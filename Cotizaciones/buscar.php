...
if($consulta = mysqli_query($conexion, "Call Buscar_Cotizaciones_Admin ('$texto%')")){
    echo 
    ...
    if ($consulta) {
        while($row = mysqli_fetch_array($consulta)){
    	    ...
    	    $consulta2 = mysqli_query($conexion2, "Call Sumar_Cantidad_Cotizaciones ('$id')") or die ("P: ".mysqli_error($conexion2));
    	    $cantidad = 0;
    	    $resto_cotizacion = 0;
                ...
                echo "<tr>
                        ...
                        <td><button id='eliminar' data-producto='".$producto."' data-id_eliminar='".$row[1]."'>Eliminar </button></td></tr>";
        }
    }
    echo "</tbody></table>";
    $consulta->close();
