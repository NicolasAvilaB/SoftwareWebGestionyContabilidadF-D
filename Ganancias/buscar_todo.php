...
$consulta = $conexion->query("Call Total_NotaVenta_Ganancia_Filtracion_Todo()");
$consulta2 = $conexion2->query("Call Total_Factura_Ganancia_Filtracion_Todo()");
$consulta3 = $conexion3->query("Call Total_NotaCredito_Ganancia_Filtracion_Todo()");
...
$consulta9 = $conexion9->query("Call Total_Pago_Instalacion_Ganancia_Filtracion_Todo()");
...
if($consulta = mysqli_query($conexion8, "Call Buscar_Factura_Credito_Filtracion_Todo ()")){
...
if($consulta111 = mysqli_query($conexion111, "Call Mostrar_NotaVenta_Sin_Facturas_Todo ()")){
