...
$texto = $_POST["texto"];
$consulta = $conexion->query("Call Total_NotaVenta_Ganancia_Filtracion_Ano ('$texto')");
$consulta2 = mysqli_query($conexion2,"Call Total_Factura_Ganancia_Filtracion_Ano ('$texto')");
$consulta3 = mysqli_query($conexion3,"Call Total_NotaCredito_Ganancia_Filtracion_Ano ('$texto')");
$consulta4 = $conexion4->query("Call Total_Gastos_Ganancia_Filtracion_Ano ('$texto')");
$consulta6 = $conexion6->query("Call Total_Retiro_Socios_Ganancia_Filtracion_Ano ('$texto')");
$consulta7 = $conexion7->query("Call Total_Pago_Creditos_Ganancia_Filtracion_Ano ('$texto')");
$consulta9 = $conexion9->query("Call Total_PagoInstalacion_Filtracion_Ano ('$texto')");
$consultax = $conexionx->query("Call Total_Credito_Filtracion_Ano ('$texto')");
$consultaxx = $conexionxx->query("Call Total_Compra_Filtracion_Ano ('$texto')");
$total_notaventa = 0;
$total_factura = 0;
$total_credito = 0;
$total_inst = 0;
...
echo '<br></br>
    ...
    <br></br>';
if($consulta5 = mysqli_query($conexion5,"Call Todo_Gastos_Ganancia_Filtracion_Ano ('$texto')")){
...
if($consulta = mysqli_query($conexion8, "Call Buscar_Factura_Credito_Filtracion_Ano ('$texto')")){
...
if($consulta111 = mysqli_query($conexion111, "Call Mostrar_NotaVenta_Sin_Facturas_Ano ('$texto')")){
