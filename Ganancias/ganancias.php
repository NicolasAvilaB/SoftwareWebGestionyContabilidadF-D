...
<div class="tablascroll">
    ...
    <div id="buscar_nota_venta">
        ...
        <p></p>
        <label><strong>Nota Crédito:&nbsp;&nbsp;</strong><input type="text" id="ncredito" style="font-size: 1.1vw; padding:3px 3px 3px 10px" value="0" disabled></input></label>
        <p></p>
        <label><strong>Instalación:&nbsp;&nbsp;</strong><input type="text" id="instalacion" style="font-size: 1.1vw; padding:3px 3px 3px 10px" value="0" disabled></input></label>
        <p></p>
        <!--
        <label>Mano de Obra: <input id="manodeobra" value="0" disabled></input></label>
        <p></p>
        <label>Mantención: <input id="mantencion" value="0" disabled></input></label>
        <p></p>
