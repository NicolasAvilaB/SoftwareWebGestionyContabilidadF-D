...
$texto = $_POST["texto"];
$texto2 = $_POST["texto2"];
$consulta = $conexion->query("Call Total_NotaVenta_Ganancia_Filtracion_Empr_Ano ('$texto','$texto2')");
$consulta2 = mysqli_query($conexion2,"Call Total_Factura_Ganancia_Filtracion_Empr_Ano ('$texto','$texto2')");
$consulta3 = mysqli_query($conexion3,"Call Total_NotaCredito_Ganancia_Filtracion_Empr_Ano ('$texto','$texto2')");
$consulta4 = $conexion4->query("Call Total_Gastos_Ganancia_Filtracion_Ano ('$texto2')");
$consulta6 = $conexion6->query("Call Total_Retiro_Socios_Ganancia_Filtracion_Ano ('$texto2')");
$consulta7 = $conexion7->query("Call Total_Pago_Creditos_Ganancia_Filtracion_Ano ('$texto2')");
$consulta9 = $conexion9->query("Call Total_PagoInstalacion_Filtracion_Empr_Ano ('$texto','$texto2')");
$consultax = $conexionx->query("Call Total_Credito_Filtracion_Ano ('$texto2')");
$consultaxx = $conexionxx->query("Call Total_Compra_Filtracion_Ano ('$texto2')");
$total_notaventa = 0;
$total_factura = 0;
$total_credito = 0;
$total_inst = 0;
...
echo '<br></br>
        ...
        <br></br>';
if($consulta5 = mysqli_query($conexion5,"Call Todo_Gastos_Ganancia_Filtracion_Ano ('$texto2')")){
...
if($consulta = mysqli_query($conexion8, "Call Buscar_Factura_Credito_Filtracion_Empr_Ano ('$texto','$texto2')")){
...
if($consulta111 = mysqli_query($conexion111, "Call Mostrar_NotaVenta_Sin_Facturas_Empr_Ano ('$texto','$texto2')")){
