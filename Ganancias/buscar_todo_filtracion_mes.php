...
$texto = $_POST["texto"];
$consulta = $conexion->query("Call Total_NotaVenta_Ganancia_Filtracion_Mes ('$texto')");
$consulta2 = $conexion2->query("Call Total_Factura_Ganancia_Filtracion_Mes ('$texto')");
$consulta3 = $conexion3->query("Call Total_NotaCredito_Ganancia_Filtracion_Mes ('$texto')");
...
$consulta9 = $conexion9->query("Call Total_Pago_Instalaciones_Ganancia_Filtracion_Mes ('$texto')");
$consultax = $conexionx->query("Call Total_Credito_Filtracion_Mes ('$texto')");
$consultaxx = $conexionxx->query("Call Total_Compra_Filtracion_Mes ('$texto')");
$total_notaventa = 0;
$total_factura = 0;
$total_credito = 0;
$total_inst = 0;
