...
$texto = $_POST["texto"];
$texto2 = $_POST["texto2"];
$consulta = $conexion->query("Call Total_NotaVenta_Ganancia_Filtracion_Mes_Ano ('$texto','$texto2')");
$consulta2 = mysqli_query($conexion2,"Call Total_Factura_Ganancia_Filtracion_Mes_Ano ('$texto','$texto2')");
$consulta3 = mysqli_query($conexion3,"Call Total_NotaCredito_Ganancia_Filtracion_Mes_Ano ('$texto','$texto2')");
...
$consulta9 = $conexion9->query("Call Total_PagoInstalacion_Filtracion_Mes_Ano ('$texto','$texto2')");
...
if($consulta = mysqli_query($conexion8, "Call Buscar_Factura_Credito_Filtracion_Mes_Ano ('$texto','$texto2')")){
...
if($consulta111 = mysqli_query($conexion111, "Call Mostrar_NotaVenta_Sin_Facturas_Mes_Ano ('$texto','$texto2')")){
