...
$conexion2122 = mysqli_connect("127.0.0.1","nicolas_usersoc","usersocifyd","nicolas_socifyd");
mysqli_set_charset($conexion,"utf8");
$conexion2 = new mysqli("127.0.0.1","nicolas_usersoc","usersocifyd","nicolas_socifyd");
$conexion212245 = mysqli_connect("127.0.0.1","nicolas_usersoc","usersocifyd","nicolas_socifyd");
mysqli_set_charset($conexion,"utf8");
...
if(!$consulta){
    ...
    while($row = mysqli_fetch_array($consulta)){
        ...
        if($id0 == $id_comp){
            ...
            echo "<tr><td><a href='generar_notaventapdf.php?id=".$id0."&idc=".$id_cliente."' type='button' value='View PDF' class='btn btn-primary' target='_blank'>".$id0."</td>";
