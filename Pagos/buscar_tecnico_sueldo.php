...
$texto = $_POST["texto"];
if($consulta = $conexion->query("Call Buscar_Tecnico_Sueldo('$texto')")){
        ...
        while($row = $consulta->fetch_assoc()){
            ...
            echo "<tr>
                ...
                if ($tip == 'Instalacion'){
                    ...
                    /*$conexion5555 = new mysqli("127.0.0.1","nicolas_usersoc","usersocifyd","nicolas_socifyd");
                    $consulta5555 = $conexion5555->query("Call Mostrar_Precio_Pagos_Tipo_Tecnico_Instalacion('$numnotaventa')");
                    if($row5555 = $conexion5555->fetch_assoc()){
                        $valor_unit_inst = $row5555["ValorUnitario"];
                    };*/
                ...
                <td contentEditable>".$bonodescs."</td>
    ...
    echo "</tbody></table><script>$('#sueldo_total').val('".$suma_total."');
    $('label#label_total').css('display','block');
    </script>";
    $consulta->close();
