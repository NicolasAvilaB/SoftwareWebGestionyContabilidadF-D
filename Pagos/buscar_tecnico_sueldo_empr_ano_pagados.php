...
$texto2 = $_POST["texto2"];
$texto3 = $_POST["texto3"];
if($consulta = $conexion->query("Call Mostrar_Filtro_Pagos_Admin_Empr_Ano_Pagados('$texto','$texto3','$texto2')")){
        ...
        while($row = $consulta->fetch_assoc()){
          ...
          $bonodescs = $row["Bono_Desc"];
            ...
            echo "<tr>
                ...
                <td><button id='quitar_pagad' class='quitar_pagad' data-id_modificar='".$row["Id"]."' data-fecha_pagado='".$fecha_pag."' data-tipo='".$tip."'>Quitar Pagado</button></td>  <td contentEditable>".$bonodescs."</td>
