...
$texto = $_POST["texto"];
if($consulta = $conexion->query("select Id, Fecha, NotaVenta, Cliente, Tipo, Cantidad, ValorUnit, ValorTotal, Pagado, Bono_Desc, Estado_Bono from Pagos where Tecnico = '$texto'")){
