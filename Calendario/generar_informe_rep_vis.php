...
//Cabecera de página
   ...
   function Header()
   {
       if ($this->PageNo() == 1){
        ...
        //Salto de línea
            ...
            $this->Cell(60,5,utf8_decode($detalle));
            $this->Ln(8);
            $this->SetFont('Arial','',12);
            $this->Cell(-1);
            ...
            $this->Cell(60,5,utf8_decode('Vendedora: '.$vendedora).'.-');
            $this->Ln(5);
            $this->Cell(-1);
   ...
   function TablaSimple()
   {
        ...
        //otros
        //Título
        $observacionescl = $_REQUEST["obsercl"];
        ...
        $this->Ln(-45);
        $this->SetFont('Arial','',11);
        $this->MultiCell(213,5,utf8_decode($observacionescl));
        $this->Ln(10);
        ...
        $this->Ln(-45);
        $this->SetFont('Arial','',11);
        $this->MultiCell(213,5,utf8_decode($observaciones));
   }
