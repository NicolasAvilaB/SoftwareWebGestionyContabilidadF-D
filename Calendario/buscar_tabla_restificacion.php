...
$texto3 = $_POST["texto3"];
$texto4 = $_POST["texto4"];
echo "<p>&nbsp</p><a id='boton_generar_informe' href='generar_informe_rest.php?id=".$texto."&idc=".$texto2."&obser=".$texto3."&tecni=".$texto4."' type='button' value='View PDF' class='btn btn-primary' target='_blank'>Informe </a>
        ...
        if(!$consulta){
		    ...
		    <td><select class='color_add' id='color_add'>
	            ...
	            <td><select class='lama_add' id='lama_add'>
                    ...
                    <td><button id='quitar_fila'>X</button></td></tr>";
            }
        }
    }
