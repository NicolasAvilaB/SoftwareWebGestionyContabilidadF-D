...
$consulta = mysqli_query($conexion,"Call Ingresar_Calendario_Admin ('$titulo','$fechainicio','$fechafin','$color','$tecnico','$horario','$detalle','$idcliente','$nombre','$direccion','$comuna','$telefono','$observaciones','$vendedora')")or die (mysqli_error($conexion));
if(!$consulta){
