...
<label id="titulo2" class= "titulo2">Promedio Venta </label>
...
<button id="desplegar_item" class="dropbtn">Prom. Ventas</button>
</div>
<div id="pestanas"></div>
<div class="tablascroll">
    ...
    &nbsp;&nbsp;&nbsp;<button id="filtrar1">Filtrar</button>
    <div id="result1"></div>
...
$("#filtrar1").on("click",function(){
    ...
    //var empr = $("#empresa_seleccionada option:selected").val();
    if (mes == '0' && ano != '234'){
    ...
    /*if (mes == '0' && ano == '234' && empr != '1'){
        $('#accion3 tbody tr').each(function (index) {
            var empresa = $("#empresa_seleccionada").val();
            $.ajax({
                url: "insertar_totalpersiana_empresa.php",
                method: "POST",
                data: {empresa: empresa},
                success: function(data){}
            });
    ...
    if (mes == '0' && ano != '234' && empr != '1'){
        ...
        var empresa= $("#empresa_seleccionada").val();
            $.ajax({
                url: "insertar_totalpersiana_ano_empresa.php",
                method: "POST",
                data: {ano: ano, empresa: empresa},
                success: function(data){}
            });
    ...
    if(mes !='0' && ano != '234' && empr != '1'){
        ...
        var empresa= $("#empresa_seleccionada").val();
            $.ajax({
                url: "insertar_totalpersiana_mes_ano_empresa.php",
                method: "POST",
                data: {mes: mes, ano: ano, empresa: empresa},
                success: function(data){}
            });
    ...
    /*if (mes == '0' && ano == '234' && empr != '1'){
        $('#accion3 tbody tr').each(function (index) {
            var empresa = $("#empresa_seleccionada").val();
            $.ajax({
                url: "insertar_totalroller_empresa.php",
                method: "POST",
                data: {empresa: empresa},
                success: function(data){}
            });
    ...
    if (mes == '0' && ano != '234' && empr != '1'){
        ...
        var empresa= $("#empresa_seleccionada").val();
            $.ajax({
                url: "insertar_totalroller_ano_empresa.php",
                method: "POST",
                data: {ano: ano, empresa: empresa},
                success: function(data){}
            });
    ...
    if(mes !='0' && ano != '234' && empr != '1'){
        ...
        var empresa= $("#empresa_seleccionada").val();
            $.ajax({
                url: "insertar_totalroller_mes_ano_empresa.php",
                method: "POST",
                data: {mes: mes, ano: ano, empresa: empresa},
                success: function(data){}
            });
    ...
    if (mes == '0' && ano == '234'){
        ...
        var empresa= $(this).find('td').eq(0).text();
            $.ajax({
                url: "insertar_totalrepuesto_todo.php",
                method: "POST",
                data: {empresa: empresa},
                success: function(data){}
            });
    ...
    /*if (mes == '0' && ano == '234' && empr != '1'){
        $('#accion3 tbody tr').each(function (index) {
            var empresa = $("#empresa_seleccionada").val();
            $.ajax({
                url: "insertar_totalrepuesto_empresa.php",
                method: "POST",
                data: {empresa: empresa},
                success: function(data){}
            });
    ...
    if (mes == '0' && ano != '234' && empr != '1'){
        ...
        var empresa= $("#empresa_seleccionada").val();
            $.ajax({
                url: "insertar_totalrepuesto_ano_empresa.php",
                method: "POST",
                data: {ano: ano, empresa: empresa},
                success: function(data){}
            });
    ...
    if(mes !='0' && ano != '234' && empr != '1'){
        ...
        var empresa= $("#empresa_seleccionada").val();
            $.ajax({
                url: "insertar_totalrepuesto_mes_ano_empresa.php",
                method: "POST",
                data: {mes: mes, ano: ano, empresa: empresa},
                success: function(data){}
            });
    ...
    if (mes == '0' && ano == '234'){
        ...
        var empresa= $(this).find('td').eq(0).text();
            $.ajax({
                url: "insertar_totalotros_todo.php",
                method: "POST",
                data: {empresa: empresa},
                success: function(data){}
            });
    ...
    /*if (mes == '0' && ano == '234' && empr != '1'){
        $('#accion3 tbody tr').each(function (index) {
            var empresa = $("#empresa_seleccionada").val();
            $.ajax({
                url: "insertar_totalotros_empresa.php",
                method: "POST",
                data: {empresa: empresa},
                success: function(data){}
            });
    ...
    if (mes == '0' && ano != '234' && empr != '1'){
        ...
        var empresa= $("#empresa_seleccionada").val();
            $.ajax({
                url: "insertar_totalotros_ano_empresa.php",
                method: "POST",
                data: {ano: ano, empresa: empresa},
                success: function(data){}
            });
    ...
    if(mes !='0' && ano != '234' && empr != '1'){
        ...
        var empresa= $("#empresa_seleccionada").val();
            $.ajax({
                url: "insertar_totalotros_mes_ano_empresa.php",
                method: "POST",
                data: {mes: mes, ano: ano, empresa: empresa},
                success: function(data){}
            });
...
$("#filtrar2").on("click",function(){
    ...
    if (mes == '0' && ano != '234'){
        ...
        var empresa= $(this).find('td').eq(0).text();
            $.ajax({
                url: "insertar_totalrepuesto_ano2.php",
                method: "POST",
                data: {ano: ano, empresa: empresa},
                success: function(data){}
            });
    ...
    if(mes !='0' && ano != '234'){
        ...
        var empresa= $(this).find('td').eq(0).text();
            $.ajax({
                url: "insertar_totalrepuesto2.php",
                method: "POST",
                data: {mes: mes, ano: ano, empresa: empresa},
                success: function(data){}
            });
    ...
    if (mes == '0' && ano == '234'){
        ...
        var empresa= $(this).find('td').eq(0).text();
            $.ajax({
                url: "insertar_totalrepuesto2_todo.php",
                method: "POST",
                data: {empresa: empresa},
                success: function(data){}
            });
    ...
    if (mes == '0' && ano != '234'){
        ...
        var empresa= $(this).find('td').eq(0).text();
            $.ajax({
                url: "insertar_totalotros_ano2.php",
                method: "POST",
                data: {ano: ano, empresa: empresa},
                success: function(data){}
            });
    ...
    if (mes == '0' && ano == '234'){
        ...
        var empresa= $(this).find('td').eq(0).text();
            $.ajax({
                url: "insertar_totalotros2_todo.php",
                method: "POST",
                data: {empresa: empresa},
                success: function(data){}
            });
...
$("#filtrar3").on("click",function(){
    ...
    if (mes == '0' && ano != '234'){
        ...
        var empresa= $(this).find('td').eq(0).text();
            $.ajax({
                url: "insertar_totalrepuesto_ano3.php",
                method: "POST",
                data: {ano: ano, empresa: empresa},
                success: function(data){}
            });
    ...
    if (mes !='0' && ano != '234'){
        ...
        var empresa= $(this).find('td').eq(0).text();
            $.ajax({
                url: "insertar_totalrepuesto3.php",
                method: "POST",
                data: {mes: mes, ano: ano, empresa: empresa},
                success: function(data){}
            });
    ...
    if (mes == '0' && ano == '234'){
        ...
        var empresa= $(this).find('td').eq(0).text();
            $.ajax({
                url: "insertar_totalrepuesto3_todo.php",
                method: "POST",
                data: {empresa: empresa},
                success: function(data){}
            });
    ...
    if (mes == '0' && ano != '234'){
        ...
        var empresa= $(this).find('td').eq(0).text();
            $.ajax({
                url: "insertar_totalotros_ano3.php",
                method: "POST",
                data: {ano: ano, empresa: empresa},
                success: function(data){}
            });
    ...
    if (mes == '0' && ano == '234'){
        ...
        var empresa= $(this).find('td').eq(0).text();
            $.ajax({
                url: "insertar_totalotros3_todo.php",
                method: "POST",
                data: {empresa: empresa},
                success: function(data){}
            });
...
$("#filtrar4").on("click",function(){
    ...
    if (mes == '0' && ano != '234'){
        ...
        var empresa= $(this).find('td').eq(0).text();
            $.ajax({
                url: "insertar_totalrepuesto_ano4.php",
                method: "POST",
                data: {ano: ano, empresa: empresa},
                success: function(data){}
            });
    ...
    if(mes !='0' && ano != '234'){
        ...
        var empresa= $(this).find('td').eq(0).text();
            $.ajax({
                url: "insertar_totalrepuesto4.php",
                method: "POST",
                data: {mes: mes, ano: ano, empresa: empresa},
                success: function(data){}
            });
    ...
    if (mes == '0' && ano == '234'){
        ...
        var empresa= $(this).find('td').eq(0).text();
            $.ajax({
                url: "insertar_totalrepuesto4_todo.php",
                method: "POST",
                data: {empresa: empresa},
                success: function(data){}
            });
    ...
    if (mes == '0' && ano != '234'){
        ...
        var empresa= $(this).find('td').eq(0).text();
            $.ajax({
                url: "insertar_totalotros_ano4.php",
                method: "POST",
                data: {ano: ano, empresa: empresa},
                success: function(data){}
            });
    ...
    if (mes == '0' && ano == '234'){
        ...
        var empresa= $(this).find('td').eq(0).text();
            $.ajax({
                url: "insertar_totalotros4_todo.php",
                method: "POST",
                data: {empresa: empresa},
                success: function(data){}
            });
